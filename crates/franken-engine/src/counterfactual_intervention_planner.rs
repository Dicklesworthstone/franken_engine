...
pub fn select_best_wave(
    ...
    let best = viable
        ...
        .expect("operation should succeed for valid inputs"); // safe: viable is non-empty
...
mod tests {
    ...
    fn plan_wave_respects_risk_budget() {
        ...
        let wave = plan_wave(passes, 100_000).expect("operation should succeed for valid inputs");
    ...
    fn select_best_wave_picks_highest_uplift() {
        ...
        let decision = select_best_wave(vec![w1, w2], MILLIONTHS)
            .expect("operation should succeed for valid inputs");

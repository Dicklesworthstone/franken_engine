...
mod tests {
    ...
    fn backend_id_serde_roundtrip() {
        ...
        let back: BackendId = serde_json::from_str(&json).expect("deserialize known-valid JSON");
        assert_eq!(id, back);
    }
    ...
    fn policy_serde_roundtrip() {
        ...
        let back: BackendSelectionPolicy =
            serde_json::from_str(&json).expect("deserialize known-valid JSON");
    ...
    fn parser_serde_roundtrip() {
        let parser = make_parser();
        let json = serde_json::to_string(&parser).expect("serialize derived Serialize");
        let back: DualBackendParser =
            serde_json::from_str(&json).expect("deserialize known-valid JSON");
    ...
    fn differential_result_serde_roundtrip() {
        ...
        let back: DifferentialComparisonResult =
            serde_json::from_str(&json).expect("deserialize known-valid JSON");
    ...
    fn parse_event_serde_roundtrip() {
        ...
        let back: DualBackendParseEvent =
            serde_json::from_str(&json).expect("deserialize known-valid JSON");
    ...
    fn error_serde_roundtrip_all_variants() {
        ...
        for v in &variants {
            ...
            let back: DualBackendParserError =
                serde_json::from_str(&json).expect("deserialize known-valid JSON");
            assert_eq!(*v, back);
        }
    }

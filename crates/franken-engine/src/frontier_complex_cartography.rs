...
mod tests {
    ...
    fn test_build_complex_single_vertex() {
        ...
        let complex = build_complex(simplices).expect("operation should succeed for valid inputs");
    ...
    fn test_build_complex_content_hash_deterministic() {
        ...
        let c1 = build_complex(s1).expect("operation should succeed for valid inputs");
        let c2 = build_complex(s2).expect("operation should succeed for valid inputs");
    ...
    fn test_compute_persistence_standard_complex() {
        let complex = build_complex(standard_complex_simplices())
            .expect("operation should succeed for valid inputs");
        let diagram = compute_persistence(&complex).expect("operation should succeed for valid inputs");
    ...
    fn test_euler_characteristic_single_vertex() {
        let complex = build_complex(vec![make_vertex("v0", "a", 0)])
            .expect("operation should succeed for valid inputs");
    ...
    fn test_bottleneck_distance_different_sizes_none() {
        let c1 = build_complex(vec![make_vertex("v0", "a", 0)])
            .expect("operation should succeed for valid inputs");
        let d1 = compute_persistence(&c1).expect("operation should succeed for valid inputs");
        let c2 = build_complex(standard_complex_simplices())
            .expect("operation should succeed for valid inputs");
        let d2 = compute_persistence(&c2).expect("operation should succeed for valid inputs");

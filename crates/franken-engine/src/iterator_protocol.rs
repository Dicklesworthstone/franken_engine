...
mod tests {
    ...
    fn trace_serde_is_deterministic() {
        ...
        let json1 = serde_json::to_string(&trace).expect("serde deserialization should succeed");
        let json2 = serde_json::to_string(&trace).expect("serde deserialization should succeed");

...
mod tests {
    ...
    fn attempt_serde_roundtrip() {
        ...
        let back: ProofAttempt = serde_json::from_str(&json).expect("deserialize known-valid JSON");
        assert_eq!(a, back);
    }
    ...
    fn archive_serde_roundtrip() {
        ...
        let json = serde_json::to_string(&archive).expect("serialize derived Serialize");

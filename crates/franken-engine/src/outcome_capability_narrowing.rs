...
mod tests {
    ...
    fn test_outcome_serde_roundtrip() {
        for outcome in [
            ...
            let round: BoundaryOutcome = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_validator_combined_narrowing_and_outcome() {
        ...
        let last = validator.transitions().last().expect("serde deserialization should succeed");
    ...
    fn test_report_serde_roundtrip() {
        ...
        let round: NarrowingReport = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_capability_grant_serde_roundtrip() {
        for grant in [
            ...
            let round: CapabilityGrant = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_boundary_transition_serde_roundtrip() {
        ...
        let round: BoundaryTransition = serde_json::from_str(&json).expect("serde deserialization should succeed");
        assert_eq!(t, round);
    }
    ...
    fn test_capability_token_serde_roundtrip_all_variants() {
        for token in CapabilityToken::all() {
            ...
            let round: CapabilityToken = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_narrowing_direction_serde_roundtrip() {
        for dir in [
            ...
            let round: NarrowingDirection = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_outcome_propagation_rule_serde_roundtrip_all_variants() {
        ...
        for rule in &rules {
            ...
            let round: OutcomePropagationRule = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_narrowing_violation_serde_roundtrip_all_variants() {
        ...
        for v in &violations {
            ...
            let round: NarrowingViolation = serde_json::from_str(&json).expect("serde deserialization should succeed");
    ...
    fn test_validator_serde_roundtrip_preserves_state() {
        ...
        let round: CapabilityNarrowingValidator = serde_json::from_str(&json).expect("serde deserialization should succeed");

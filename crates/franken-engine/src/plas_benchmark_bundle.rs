...
mod tests {
    ...
    fn build_bundle_deterministic() {
        let r = make_request();
        let d1 = build_plas_benchmark_bundle(&r).expect("serde deserialization should succeed");
        let d2 = build_plas_benchmark_bundle(&r).expect("serde deserialization should succeed");

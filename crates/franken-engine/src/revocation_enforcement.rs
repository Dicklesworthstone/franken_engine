...
mod tests {
    ...
    fn high_risk_denied_for_revoked_principal_key() {
        ...
        match result {
            ...
            // SAFETY: Test validates revocation enforcement transitive denial for attestations
            _ => panic!("expected transitive denial"),
        }
    }

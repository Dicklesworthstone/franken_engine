...
mod tests {
    ...
    fn version_serde_roundtrip() {
        ...
        let back: PackVersion = serde_json::from_str(&json).expect("deserialize known-valid JSON");
        assert_eq!(v, back);
    }
    ...
    fn catalog_serde_roundtrip() {
        ...
        let back: PackCatalog = serde_json::from_str(&json).expect("deserialize known-valid JSON");
    ...
    fn rule_interference_serde() {
        ...
        let json = serde_json::to_string(&interf).expect("serialize derived Serialize");

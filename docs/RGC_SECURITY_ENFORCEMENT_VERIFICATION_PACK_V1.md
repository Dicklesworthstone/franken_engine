...
By default, the replay wrapper reruns the lane and then prints the latest complete
artifact bundle (`run_manifest.json`, `trace_ids.json`, `events.jsonl`,
`commands.txt`, `step_logs/step_000.log`, and

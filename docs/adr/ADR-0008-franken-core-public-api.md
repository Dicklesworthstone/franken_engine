...
- `entropy_evidence_compressor`: constant `ENTROPY_SCHEMA_VERSION`; enum `EntropyError`; structs `EntropyEstimator`, `SufficientStatistic`, `ArithmeticCoder`, `CompressedEvidence`, `CompressionCertificate`.
